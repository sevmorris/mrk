...
**[Barkeep](https://github.com/sevmorris/Barkeep)** is a native macOS companion app for visually managing your Homebrew Brewfile. It is installed automatically during `make post-install`.
