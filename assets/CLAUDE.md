...
- **JustLoop** — **Retired on 2026-09-24**, with no successor. Dropped an audio file and looped it, from the menu bar. The GitHub repo is archived; no features, no releases.
- **JustIn** — **Retired on 2026-09-24**; WaxOn/WaxOff covers it. A media file analyzer, kept one folder down at `JustIn/JustIn`. The GitHub repo is archived, and installed copies keep reporting v1.0.4 as current, since its update check reads the archived releases.
